export declare const $lib: import("@typespec/compiler").TypeSpecLibrary<{
    ...
    "deprecated-implicit-optionality": {
        readonly default: "The implicitOptionality option is deprecated. To preserve previous behavior, use an explicit patch model with optional properties. For actual merge-patch semantics, use MergePatchUpdate<T> for the @body type.";
    };
